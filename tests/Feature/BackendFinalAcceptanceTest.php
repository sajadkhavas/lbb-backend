...
class BackendFinalAcceptanceTest extends TestCase
{
    ...
    public function test_backend_is_accepted_on_the_exact_frozen_contract_without_claiming_frontend_or_deployment(): void
    {
        $this->getJson('/api/system/contracts')
            ...
            ->assertJsonPath('data.contracts.backend_freeze.contract_version', '2026-08-09-f14-be-f')
    ...
    public function test_final_acceptance_preserves_openapi_freeze_and_commerce_truth_boundaries(): void
    {
        ...
        $this->assertSame('F14-BE-F', $document['x-lbb-freeze']['phase']);
