...
Route::prefix('system')->middleware('throttle:60,1')->group(function () {
    Route::get('health', [SystemController::class, 'health']); Route::get('ready', [SystemController::class, 'ready']);
    Route::get('meta', [SystemController::class, 'meta']); Route::get('contracts', [SystemController::class, 'contracts']);
    Route::get('openapi', [SystemController::class, 'openapi']);
});
Route::prefix('catalog')->middleware('throttle:120,1')->group(function () {
    Route::get('products', [CatalogController::class, 'products']); Route::get('products/{slug}', [CatalogController::class, 'product']);
    Route::get('products/{slug}/reviews', [ReviewController::class, 'index']); Route::get('categories', [CatalogController::class, 'categories']);
});
...
Route::prefix('store')->middleware('throttle:120,1')->group(function () {
    Route::get('settings', [StoreContentController::class, 'settings']); Route::get('pages/{slug}', [StoreContentController::class, 'page']);
    Route::get('faqs', [StoreContentController::class, 'faqs']); Route::get('gallery', [StoreContentController::class, 'gallery']);
    Route::get('posts', [StoreContentController::class, 'posts']); Route::get('posts/{slug}', [StoreContentController::class, 'post']);
});
...
Route::prefix('auth')->group(function () {
    ...
    Route::middleware(['auth:customer', 'customer.active', 'throttle:60,1'])->group(function () {
        Route::get('me', [OtpAuthController::class, 'me']); Route::post('logout', [OtpAuthController::class, 'logout']);
    });
});
...
Route::middleware(['auth:customer', 'customer.active'])->group(function () {
    ...
    Route::prefix('account')->middleware('throttle:60,1')->group(function () {
        ...
        Route::get('addresses', [AccountAddressController::class, 'index']); Route::post('addresses', [AccountAddressController::class, 'store']);
        Route::put('addresses/{addressId}', [AccountAddressController::class, 'update']); Route::delete('addresses/{addressId}', [AccountAddressController::class, 'destroy']);
        Route::get('orders', [AccountOrderController::class, 'index']); Route::get('orders/{orderId}', [AccountOrderController::class, 'show']);
